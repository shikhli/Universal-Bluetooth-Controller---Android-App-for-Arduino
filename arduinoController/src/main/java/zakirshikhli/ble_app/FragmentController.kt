...
class FragmentController : Fragment(), ServiceConnection,
    ...
    private lateinit var blocker: AppCompatTextView
    ...
    override fun onServiceDisconnected(name: ComponentName) {
        ...
        val errorMessage: String = resources.getString(R.string.connection_lost)
        Log.e("TAG", errorMessage)

        connStatus.text = errorMessage
        setNoConnection()
    ...
    private fun uiFunc() {
        ...
        connStatus.text = getString(R.string.waitText)
        setNoConnection()
    ...
    override fun onSerialConnectError(e: Exception?) {
        ...
        val errorMessage: String = resources.getString(R.string.could_not_connect)
        connStatus.text = errorMessage
        setNoConnection()


        Log.e("TAG", "$errorMessage ${e!!.message} onSerialConnectError")
    ...
    private fun setNoConnection(success: Boolean = false) {
        if (success){
            connected = Connected.True

            val connectedStatusText: String = if (btIsClassic){
                getString(R.string.conn_status) + deviceAddress + " (Classic)"
            }else{
                getString(R.string.conn_status) + deviceAddress + " (BLE)"
            }
            connStatus.text = connectedStatusText

            indicatorCon.setImageResource(R.drawable.indicator_green)

            blocker.text = getString(R.string.waitText)
