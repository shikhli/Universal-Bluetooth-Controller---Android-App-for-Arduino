...
class PageMainActivity : AppCompatActivity(), FragmentManager.OnBackStackChangedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonBLE.setOnClickListener {
            ...
            supportFragmentManager.beginTransaction()
                .add(R.id.fragment, PageDevicesBLEFragment(), "devices").addToBackStack(null)
                .commit()
        }
        ...
        buttonClassic.setOnClickListener {
            ...
            Handler().postDelayed({
                supportFragmentManager.beginTransaction()
                    .add(R.id.fragment, PageControllerFragment(), "classic").addToBackStack(null)
                    .commit()
            }, 100)
        }
    ...
    override fun onBackPressed() {
        ...
        val fragmentDevices: Fragment? = supportFragmentManager.findFragmentByTag("devices")
        val fragmentClassic: Fragment? = supportFragmentManager.findFragmentByTag("classic")
        val fragmentBLE: Fragment? = supportFragmentManager.findFragmentByTag("ble")

        if ((fragmentDevices != null && fragmentDevices.isVisible) || (fragmentClassic != null && fragmentClassic.isVisible) || (fragmentBLE != null && fragmentBLE.isVisible)) {
