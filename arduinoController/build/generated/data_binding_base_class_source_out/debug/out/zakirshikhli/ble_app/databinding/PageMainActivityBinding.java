...
public final class PageMainActivityBinding implements ViewBinding {
  @NonNull
  ...
  private PageMainActivityBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static PageMainActivityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PageMainActivityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.page_main_activity, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PageMainActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PageMainActivityBinding((ConstraintLayout) rootView, appBarLayout, appInfo,
          buttonBLE, buttonClassic, buttonsMm, emailButton, fragment, helpButton, helpCloseButton,
          helpPanel, helpPanelLabel, helpText, langButton, mainMenuContainer, quitButton,
          shareButton, titleImage, toolbar);
    }
