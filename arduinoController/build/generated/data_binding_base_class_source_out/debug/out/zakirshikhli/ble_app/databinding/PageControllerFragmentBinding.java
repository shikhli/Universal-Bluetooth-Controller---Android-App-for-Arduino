...
public final class PageControllerFragmentBinding implements ViewBinding {
  @NonNull
  ...
  private PageControllerFragmentBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static PageControllerFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PageControllerFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.page_controller_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PageControllerFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PageControllerFragmentBinding((ConstraintLayout) rootView, buttonsCont, connStatus,
